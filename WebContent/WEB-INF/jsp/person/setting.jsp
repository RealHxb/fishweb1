...
<div class="container" style="margin-top: 70px;">
    ...
    <form class="form-horizontal" id="personParam">
        ...
        <div class="form-group">
            <label for="input5" class="col-sm-2 control-label">队名</label>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-8">
                <button type="button" class="btn btn-success" onclick="save()">确认增加</button>
                <a class="btn btn-info"  href="javascript:location.reload()" >清空内容</a>
                <label class="btn btn-info" >总人数：${persons.size()}</label>
             	<a class="btn btn-info"  href="/person/printall" >人员名单打印</a>
